...
public class UpdateRegistrationStatusHandler(IRegistrationStatusRepository registrationStatusRepository, IMapper mapper) : IRequestHandler<UpdateRegistrationStatusCommand>
{
